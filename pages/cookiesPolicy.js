...
export default function CookiesPolicy() {
    return (
        <TermsLayout title="Cookies Policy">
            <div >
                <p>Last updated: September 20, 2018</p>

                <p>Teacher Tree Inc ("us", "we", or "our") uses cookies on the https://www.teachertree.org website (the "Service"). By using the Service, you consent to the use of cookies.</p>
                ...
                <h2>How Teacher Tree Inc uses cookies</h2>
