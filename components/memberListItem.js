import { List, Avatar, Button, message, Popconfirm, Divider } from "antd";
...
const MemberListItem = ({ teacher, school, fetchTeachers }) => {
  ...
  return (
    <>
      ...
      >
        <List.Item.Meta
          avatar={<Avatar size={60} style={{ marginBottom: "1rem" }} src={teacher.profilePhotoUrl} icon={<UserOutlined />} />}
